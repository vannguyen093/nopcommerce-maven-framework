...
public class User_01_Register extends BaseTest{
    ...
    public static String emailAddress, existingEmailAddress;
    ...
    public void TC_03_Create_Account_Successful(Method method) {
        ...
        ExtentTestManager.getTest().log(Status.INFO, "Successful - Step 06: Select '"+ userData.getDate() + "' in the 'Date' dropbox");
        userRegisterPage.selectItemInDOBDropbox("DateOfBirthMonth", userData.getMonth());

        ExtentTestManager.getTest().log(Status.INFO, "Successful - Step 07: Select '"+ userData.getDate() + "' in the 'Date' dropbox");
        userRegisterPage.selectItemInDOBDropbox("DateOfBirthYear", userData.getYear());
